...
import com.example.tools.advisors.TokenAuditUsageAdvisor;
...
public class ChatMemoryConfig {
    ...
    public ChatClient chatClientWithMemory(ChatClient.Builder chatClientBuilder ,ChatMemory chatMemory){
        ...
        return chatClientBuilder.defaultAdvisors(List.of(new SimpleLoggerAdvisor(), new TokenAuditUsageAdvisor(),memoryAdvisor)).build();
    }
